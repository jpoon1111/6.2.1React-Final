...
const Search = ({landing, searchChange, searchChangeLanding, keyword}) => {
  ...
  useEffect(()=>{
    ...
    // Update the handleSearchEvent based on landing prop
      

  }, [landing])
  // const handleSearchEvent = landing ? searchChangeLanding:searchChange
  ...
  return ( 
    <div className={landing? "landing search__bar--wrapper": "search__bar--wrapper"}>
            ...
            <div className="input__wrapper">
              <input onKeyDown={(ev)=> (ev.key === "Enter") && handleSearchEvent(ev)} 
              ...
              />
              {
                landing? ( 
                 ...
                 <buttton className="search__button" onClick={()=> initSearch()}>
